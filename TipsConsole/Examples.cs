...
namespace TipsConsole
{
	internal class Examples
	{
		...
		//	numA = 222,333,444,555; // nor allowed
			...
			//Let's conclude we've seen two options for declaring numeric literals in your code.
			//Use the underscore to make it easier to read and 
			//use the letter e to represent exponent in doubles.
